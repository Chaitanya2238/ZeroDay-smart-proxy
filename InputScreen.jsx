...
function InputScreen({
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (query.trim() || file) {
      onStartScan({ query, file, scanType: "auto" });
    }
  };
          ...
          /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
            ...
            /* @__PURE__ */ jsx(
              motion.p,
              {
                ...
                className: "text-lg",
                style: { color: "#8b92a8" },
                children: "Manual website and package vulnerability analyzer"
              }
            )
          ] }),
          /* @__PURE__ */ jsxs(
              ...
              children: [
                  /* @__PURE__ */ jsx(
                    "input",
                    {
                      ...
                      className: "w-full rounded-full border py-4 pr-6 pl-14 transition-all focus:outline-none",
                      style: {
                ...
                scanError && /* @__PURE__ */ jsx("div", { className: "rounded-lg border px-4 py-3 text-sm", style: { backgroundColor: "#ff475711", borderColor: "#ff4757", color: "#ff6b81" }, children: scanError }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
                  /* @__PURE__ */ jsxs(
                    "label",
                    {
                      className: "flex-1 flex items-center justify-center gap-3 px-6 py-4 rounded-full border cursor-pointer transition-all hover:border-[#00d9ff]",
                      style: {
                        backgroundColor: "#0f1420",
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsx(
                          ...
                          {
                            type: "file",
                            accept: ".pcap,.txt,.log,.json,.csv,.xml,.yaml,.yml,.toml,.lock",
                  ...
                  /* @__PURE__ */ jsx(motion.div, { whileHover: { scale: 1.02 }, whileTap: { scale: 0.98 }, children: /* @__PURE__ */ jsx(
                    ...
                    {
                      type: "submit",
                      className: "rounded-full px-12 py-4 font-medium transition-all",
                      style: {
